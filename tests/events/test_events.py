...
class EventTests(unittest.TestCase):
    def setUp(self):
        ...
        self.event = dict(id='calendar-check', name='測試 & 時間', start='2026-09-30T23:30:00+08:00', end='2026-10-01T01:00:00+08:00', content='<script>測試</script>', registration='採電話報名', location='測試地點')
    ...
    def test_reject_bad_dates_duplicates_and_urls(self):
        for change in [dict(end=self.event['start']), dict(start='2026-09-30T23:30:00'), dict(registrationUrl='javascript:alert(1)')]:
