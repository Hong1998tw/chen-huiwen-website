...
require('production-verification=browser-' in (R/'tests/donation/live_production_proxy.py').read_text(),'production browser proxy: browser cache namespace missing')
